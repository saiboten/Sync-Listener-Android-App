...
import saiboten.no.synclistener.MainActivity;

/**
 * Created by Tobias on 15.03.2015.
 */
public class GetSongInfoFromSpotifyByRestTask extends AsyncTask<String, Void, String> {
    private Exception exception;

    private MainActivity mainActivity;

    public GetSongInfoFromSpotifyByRestTask(MainActivity mainActivity) {
